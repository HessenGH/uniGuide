...
function Navbar(){
  return(
    ...
    <nav>
     ...
     <div>
        <ul id="navbar">
          <li className="ln"><a className="an" href="index.html">Home</a></li>
          <li className="ln"><a className="an" href="index.html">About</a></li>
          <li className="ln"><a className="an" href="index.html">Universities</a></li>
          <li className="ln"> <a className="an" href="index.html">Contact</a></li>
        </ul>
      </div>
    </nav>
    </>
